...
$sql1="SELECT * FROM `personalactivo` WHERE `personalactivo`.`sucursal` LIKE '$_SESSION[sucur]' AND `personalactivo`.`activo`=2 AND `personalactivo`.`apruebaseleccion`=2 ORDER BY '$_SESSION[ord]'";
...
$pdf->Ln();
$texto="ASPIRANTES QUE APROBARON PRUEBAS";
