...
******************************************************************************/	
$sql1="SELECT * FROM escoltas, personalactivo WHERE personalactivo.cedula = $_SESSION[cedulamod] AND escoltas.cedula=$_SESSION[cedulamod] ORDER BY escoltas.codigo";
//echo $sql1;
