...
formularioactual();
	...
	if($_POST['ejecut']=="Buscar" || $_GET['ejecut']=="Buscar"){
		...
		$_SESSION['datos']['otraconsulta']="AND personalactivo.activo = 0";
...
$muestr[1]="codigo";
$otrasent="AND (clientes.activo = 1 OR clientes.activo = 0)  AND clientes.sucursal LIKE '$_SESSION[sucur]'";
...
<!--
		function ventana(){
		window.open("fotomysql.php","Imagen","width=600px,height=600px,menubar=0,scrollbars=1");
		}
//-->
</script>
<script language="JavaScript" type="text/JavaScript">
<!--
		function ventana2(){
		window.open("subirdoc.php","Documento","width=600px,height=600px,menubar=0,scrollbars=1");
		}
                function ventanaHuellas(){
		window.open("huellas.php","Documento","width=300px,height=600px,menubar=0,scrollbars=1");
		}
//-->
</script>
</head>
<body<?php if($mens!=""){echo " onload=\"mensajeini('".addslashes($mens)."');return false;\"";}?>>
<form method="post" name="peract" id="peract" action="personalretirado3.php" enctype="multipart/form-data" onsubmit="return validaperact(boolvalidar);">
...
<table class="tablaprinc" id="tablaprinc">
			<tr>
	 		...
	 		if($focto!=""){
                            ...
                            print("<img style=\"width:".$dim['ancho']."px;height:".$dim['alto']."px\" name=\"changing\" onclick=\"ventana()\" src=\"fotosguardas/"."$focto\""."/>") ;
                        }else{
		 ...
		 if ($_SESSION['apellidosa']!=""){
			...
			<tr>
			 ...
			 if ($_SESSION['pasadojudiciala']!=""){
				...
				<td align="left"><input class="largo" name="email"
					value="<?php
			 if ($_SESSION['emaila']!=""){
			...
			<tr>
	 		...
	 		if($_SESSION[clientemod]!=""){echo "<a onclick=\"ventana2();\">Anexos ($numdocs)</a>";}
	 		?></td>
			</tr>
			<tr>
				<!-- Row 11 -->
			 ...
			 if ($_SESSION['fechanacimientoa']!=""){
			  	...
			  	echo "";}else{ echo @mysql_result($result,$_SESSION['i'],"fechanacimiento");}  ?>">
                                ...
                                <?php if($_SESSION[clientemod]!=""){echo "<a onclick=\"ventanaHuellas();\">Biometr&iacute;a</a>";}?>
                                </td>
			</tr>
			<tr>
				<!-- Row 6 -->
			...
			<tr>
				<td align="right">AFP:<select name="afp" class="largo1">
					<option value=""></option>
					<option value="309"
			...
			if ($_SESSION['afpfechaa']!=""){
			  	...
			  	echo "";}else{ echo @mysql_result($result,$_SESSION['i'],"afpfecha");}  ?>">
                        ...
                        <tr>
				<td align="right">CCF:<select name="cajacompensacion" class="largo1">
					<option value=""></option>
    				</select></td>
				<td align="left">Afiliado:<input type="checkbox"
					name="cajacheck"
			...
			<tr>
				...
				<td align="left"><input name="vencecredsuperintendencia"
					class="largo" id="vencecredsuperintendencia"
					value="<?php
...
<div id="Datos de Psicologia" style="display:none;margin-left:305px">Datos de Psicologia</div>
<div id="controlex">
<table class="control">
	<tr>
		<td colspan="2" class="arriba" align="center">Personal Inactivo
		</td>
	</tr>
	...
	<tr height="10px">
		<td colspan="2" align="center"><input type="submit" class="botoactu"
			...
			class="botoing" value="Ingresar" name="ejecut" onmousedown="boolvalidar=true;" onkeydown="boolvalidar=true;"></td>
	</tr>
	<tr height="10px">
