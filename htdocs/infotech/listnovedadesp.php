...
******************************************************************************/	
$sql1="SELECT * FROM personalactivo, ordenes WHERE personalactivo.cedula=ordenes.cedremplazo AND MONTH(ordenes.fecha)=MONTH(CURRENT_DATE()) AND personalactivo.sucursal LIKE '$_SESSION[sucur]' ORDER BY $_SESSION[ord]";
//echo $sql1;
...
$pdf->Ln();
$texto="LISTADO DE NOVEDADES DE PERSONAL MES ACTUAL";
...
$mot=verificarNovedadRadiop2(@mysql_result($result,$reg,motivo));
