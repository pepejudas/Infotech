...
function peticionPDF(nombreObjetoHTML){
       Ext.Ajax.request({
          waitMsg: 'Por favor Espere...',
          url: 'exportarPDFAjax.php',
          params: {
          textoHTML: Ext.get(nombreObjetoHTML).dom.innerHTML
          },
          ...
          var respuesta = eval(response.responseText);
              ...
              Ext.MessageBox.alert('error eval','la respuesta del servidor no es un objeto json:' + response.responseText);
          }
