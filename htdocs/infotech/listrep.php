...
$fecha=getdate(time());
$sql1="SELECT * FROM reportes, personalactivo WHERE personalactivo.cedula LIKE reportes.cedulacontrol AND `reportes`. `mescontrol` LIKE '$fecha[month]$fecha[year]' AND personalactivo.sucursal LIKE '$_SESSION[sucur]' ORDER BY $_SESSION[ord]";
