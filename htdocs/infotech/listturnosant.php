...
$fecha=getdate(time());
$sql1="SELECT * FROM controlturnos, personalactivo WHERE personalactivo.cedula LIKE controlturnos.cedulacontrol AND `controlturnos`. `mescontrol` LIKE '$cad' AND personalactivo.sucursal LIKE '$_SESSION[sucur]' ORDER BY $_SESSION[ord]";
