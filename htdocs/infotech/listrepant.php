...
$fecha=getdate(time());
$sql1="SELECT * FROM reportes, personalactivo WHERE reportes.cedulacontrol LIKE personalactivo.cedula AND `reportes`. `mescontrol` LIKE '$cad' AND personalactivo.sucursal LIKE '$_SESSION[sucur]' ORDER BY $_SESSION[ord]";
...
switch($fecha[month]):
			case "January": $mes="DICIEMBRE"; break;
			case "February": $mes="ENERO"; break;
			case "March": $mes="FEBRERO"; break;
			case "April": $mes="MARZO"; break;
			case "May": $mes="ABRIL"; break;
			case "June": $mes="MAYO"; break;
			case "July": $mes="JUNIO"; break;
			case "August": $mes="JULIO"; break;
			case "September": $mes="AGOSTO"; break;
			case "October": $mes="SEPTIEMBRE"; break;
			case "November": $mes="OCTUBRE"; break;
			case "December": $mes="NOVIEMBRE"; break;
endswitch;

$texto="CONTROL DE REPORTES NOCTURNOS ".$mes;
