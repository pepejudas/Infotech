...
$contrata=decod(@mysql_result($contr,0,contrato2));
...
$fechafin=@mysql_result($result,0,fincontrato);
...
$ciudadres=@mysql_result($result,0,codigoresidencia);

if(@mysql_result($result,0,codigo)==""){echo '<h1>!Error debe cargar una persona con codigo <br> de cliente de lo contrario no puede ser generado <br> el contrato de trabajo!</h1><br><a href="documentospersonalactivo.php" target="_top"><h3>regresar</h3></a>';exit();}
...
$texto="                         
                                 ...
                                 CONTRATO INDIVIDUAL DE TRABAJO                       
                                         INFERIOR A UN A".utf8_decode(Ñ)."O";
...
FECHA FINAL LABORES:	                  $fechafin
LUGAR A DESEMPE".utf8_decode(Ñ)."AR LABORES:$city 
";
...
$h=4;
$pdf->SetFont('Arial','B',8);
$pdf->MultiCell($w,$h,decod1($contrata),$border=0,$align='J',$fill=0);
$texto10="
