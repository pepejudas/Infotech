...
<html>
		...
		<title>Documentos Correspondencia</title>
		</head>
...
<center>
		...
		<tr>
	  		...
	  		<select name="orden" style="WIDTH: 70%" tabindex="39">
  	 		...
  	 		<option value="fecha" <?php  if ($_SESSION['ord']=="fecha") {echo ('selected=""');}?>>Fecha</option>
  	 		<option value="nombreusuario" <?php  if ($_SESSION['ord']=="nombreusuario") {echo ('selected=""');}?>>Nombre remitente</option>
  	 		<option value="problema" <?php  if ($_SESSION['ord']=="problema") {echo ('selected=""');}?>>Motivo</option>
	  		</select>Orden
			</td>
		</tr>
		...
		<tr>
			...
			<?php  if ($_SESSION['ord']=="") {echo ($_SESSION['ord']=="cedula");}?>
  	 		<option value="1" <?php  if ($_SESSION['lis']==1) {echo ('selected=""');}?>>Listado general de correspondencia</option>
  	 		<option value="2" <?php  if ($_SESSION['lis']==2) {echo ('selected=""');}?>>Listado de correspondencia sin contestar</option>
  	 		</select>Listado
  	  		</td>
		</tr>
		...
		<tr>
  			...
  			switch ($_SESSION['lis']):
  			case 1:
  			$nj='listcorrespondencia.php';
  			break;
  			case 2:
  			$nj='listcorrespondenciarespo.php';
  			break;
  			default:
  			$nj='listcorrespondencia.php';
  			endswitch;
	 	...
	 	<?php 
		$parametros[tabla]="correspondencia, clientes";
		$parametros[campos]="nombrecliente, fecha, correspondencia.codigo, nombreusuario, telefonousuario, problema, fecharegistro, fechaenviorespuesta, contestada";
		$parametros[condiciones]="correspondencia.codigo LIKE clientes.codigo AND clientes.sucursal LIKE '$_SESSION[sucur]'";
