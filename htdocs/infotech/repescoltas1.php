...
$sql1="SELECT * FROM  escoltas, personalactivo WHERE  personalactivo.cedula LIKE escoltas.cedula AND escoltas.mesreporte LIKE '$mes' ORDER BY $criterio";
//echo $sql1;
