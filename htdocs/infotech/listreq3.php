...
INNER JOIN usuarios on requisiciones.idusuarioreq=usuarios.id WHERE estado = 3 ORDER BY serialrequisicion, $_SESSION[ord]";
...
$pdf->Ln();
$texto="LISTADO DE REQUISICIONES RECHAZADAS";
