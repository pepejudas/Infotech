...
$sql1="SELECT * FROM clientes WHERE clientes.activo = 1 AND clientes.sucursal LIKE '$_SESSION[sucur]' AND clientes.duenopuesto LIKE '$_SESSION[sociolis]' ORDER BY $_SESSION[ord]";
...
$nombre=@recortarcadena(decod(@mysql_result($result,$reg,nombrecliente)),50);
$telefono=@mysql_result($result,$reg,telefono);
$administrador=recortarcadena(decod(@mysql_result($result,$reg,nombreadministrador)),26);
