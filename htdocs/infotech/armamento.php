...
<!-- ** CSS ** -->
    ...
    <script type="text/javascript" src="ext/examples/grid/totalinfoArmas.js"></script>
...
<table class="control">
	<tr>
            <td colspan="2" class="arriba"><p style="font-style: italic;font-size: 15px">Armamento</p>
            </td>
	</tr>
