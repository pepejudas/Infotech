...
$sql1r="SELECT * FROM dotacion, personalactivo, clientes WHERE personalactivo.cedula=dotacion.ceduladot AND personalactivo.codigo=clientes.codigo AND personalactivo.sucursal LIKE '$_SESSION[sucur]' AND personalactivo.activo =1 ORDER BY personalactivo.apellidos, dotacion.iddot";
...
<html>
<head>
<title>Documentos Control de Asistencia</title>
